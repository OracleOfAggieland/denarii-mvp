...
export const VoiceProvider = ({ children }) => {
  ...
  const getPageContext = useCallback(() => {
    ...
    if (pathname === '/') {
      return {
        type: 'landing_page',
        context: `You are Denarii's AI Financial Advisor on the main Purchase Advisor page. The user can interact with these features:
...
4. **Denarii Advisor Chat** (/chat): Text or voice conversations with you for financial advice
...
- If user wants to chat more - Suggest going to Denarii Advisor (/chat)
...
Be enthusiastic and helpful! Guide them through using the app effectively.`
      ...
      return {
        type: 'chat_page',
        context: `You're in the Denarii Advisor chat interface. Provide financial advice and help with purchase decisions. ${financialProfile ? `User's monthly net income: $${financialProfile.monthlyIncome - financialProfile.monthlyExpenses}` : ''}`
      };
    ...
    return {
      type: 'general',
      context: 'Help the user navigate Denarii and make smart financial decisions. Main features: Purchase Analyzer, Financial Profile, Chat, Dashboard.'
    };
  ...
  const startVoiceSession = useCallback(async () => {
    ...
    const greetingText = pageContext.type === 'landing_page' 
      ? `Hey there! I'm your Denarii AI Financial Advisor! I can see you're on the Purchase Analyzer page.
         I can help you decide if you should buy something, guide you through setting up your financial profile,
         or answer any questions about how Denarii works. You can ask me things like "Should I buy this laptop?"
     ...
     : `Hi! I'm here to help you with Denarii. What can I assist you with?`;
