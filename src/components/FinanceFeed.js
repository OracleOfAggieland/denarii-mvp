      ...
      <div className="finance-feed-container">
        ...
        <div className="feed-content">
            ...
            <div className="tips-list">
              ...
              <div className="tip-item">
                ...
                <div className="tip-content">
                  ...
                  <p>You can't manage what you don't measure. Use Denarii to analyze purchases!</p>
                </div>
              </div>
          ...
          <div className="feed-cta">
            ...
            <p>Use Denarii's Purchase Advisor to make smarter financial decisions today.</p>
