  ...
  return (
    <div className="App">
      ...
      <div className="hero-section">
        <h1 className="hero-title">About Denarii</h1>
        ...
        <div className="about-content">
          <div className="about-section">
            ...
            <p>
              ...
              financial decisions often feel insignificant, overlooked, or overwhelming. Denarii 
          ...
          <div className="about-section highlight">
            ...
            <p>
              Your first million is more attainable than you ever imagined. Let Denarii be your 
